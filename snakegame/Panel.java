...
public class Panel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics graphic) {
        if (game_flag) {
            ...
            graphic.drawString("Score:" + foodeaten, (width - font_me.stringWidth("Score" + foodeaten)) / 2,
    ...
    public void gameOver(Graphics graphic) {
        ...
        graphic.drawString("Press R to replay", (width - font_me2.stringWidth("Press R to replay")) / 2,
                height / 2 - 150);
